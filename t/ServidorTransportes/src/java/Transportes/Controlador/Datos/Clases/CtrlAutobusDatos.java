...
public class CtrlAutobusDatos extends CtrlEstacionCivicaDatos {
    ...
    /**
     * Obtiene las líneas de autobús que proporcionan sus horarios
     * @param ciudad: nombre de la ciudad
     * @param pais: nombre del pais
     * @return lista con el nombre de las líneas que forman parte de todas las 
     * estaciones de autobús y que proporcionan sus horarios
     */
    @Override
    ...
    /**
     * Obtiene los sentidos que tiene una línea de autobús
     * @param ciudad: nombre de la ciudad
     * @param pais: nombre del pais
     * @param linea: nombre de la linea
     * @return lista con el nombre de los sentidos que tiene una línea de autobus
     */
    @Override
     ...
     * @return lista de los horarios que tiene una línea de autobús en el sentido indicado
     */
    @Override
    ...
    /**
     * Obtener las paradas cercanas de estaciones de autobus a una dirección o ubicación
     * @param ciudad: nombre de la ciudad
     * @param pais: nombre del pais
     ...
     * @return lista que contiene las paradas de autobuses cercanas a la dirección 
