...
public class CtrlTelefericoDatos extends CtrlEstacionCivicaDatos{
        ...
        /**
     * Obtiene las líneas de teleferico
     * @param ciudad: nombre de la ciudad
     * @param pais: nombre del pais
     * @return lista con el nombre de las líneas que forman parte de todas las 
     * estaciones de teleferico
     */
    @Override
    public ArrayList<String> getLineas(String ciudad, String pais) {
        String fichero = folder+pais+"/"+ciudad+"/Teleferico.html";
        return obtenerLineas(fichero);
    }
    
        /**
     * Obtiene las líneas de teleferico que proporcionan sus horarios
     * @param ciudad: nombre de la ciudad
     * @param pais: nombre del pais
     * @return lista con el nombre de las líneas que forman parte de todas las 
     * estaciones de teleferico y que proporcionan sus horarios
     */
      @Override
    public ArrayList<String> getLineasHorarios(String ciudad, String pais) {
         String fichero = folder+pais+"/"+ciudad+"/Horarios/Teleferico.html";
        return obtenerLineas(fichero);
    }
    
     /**
     * Obtiene los sentidos que tiene una línea de teleferico
     * @param ciudad: nombre de la ciudad
     * @param pais: nombre del pais
     * @param linea: nombre de la linea
     * @return lista con el nombre de los sentidos que tiene una línea de teleferico
     */
    @Override
     ...
     * @return lista de los horarios que tiene una línea de teleferico en el sentido indicado
     */
    @Override
     public ArrayList<HorarioApertura> getHorarios(String ciudad, String pais,  String linea, String sentido) {
        ...
        return obtenerHorarios(fichero, linea, sentido);
         ...
         /**
     * Obtener las paradas cercanas de estaciones de teleferico a una dirección o ubicación
     * @param ciudad: nombre de la ciudad
     * @param pais: nombre del pais
     ...
     * @return lista que contiene las paradas de teleferico cercanas a la dirección 
    ...
    public ArrayList<EstructurasPublicas> getParadasCercanas(String ciudad, 
        ...
        try {
            ...
            Logger.getLogger(CtrlTelefericoDatos.class.getName()).log(Level.SEVERE, null, ex);
        }
        return null;
    }
